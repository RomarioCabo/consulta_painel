class Validation {
  static String validation(Map<String, dynamic> result) {
    ...
    if((result["errors"] as Map<String, dynamic>).containsKey("validation")) {
      Map<String, dynamic> jsonValidation = ((result["errors"] as Map<String, dynamic>)["validation"] as Map<String, dynamic>);
    ...
    else if((result["errors"] as Map<String, dynamic>).containsKey("description")) {
